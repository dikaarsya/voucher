...
error_reporting(0);
include ("func.php");
echo "\e                         GOJEK VERSION           \n";
echo "\e                   SCRIPT GOJEK AUTO REGISTER\n";
echo "\n";
nope:
...
if ($register == false)
    {
    echo "\e[x] La tedaftar, ganti nomor!\n";
    }
  else
    {
    otp:
    ...
    if ($verif == false)
		...
		fclose($h); 
                echo "\e[!] Trying to redeem Reff :G-WCVB2M9 !\n";
                sleep(3);
            $claim = reff($verif);
            if ($claim == false){
            echo "\e[!] SUCCES SILAHKAN LOGIN, AMBEK DEWEK VOUCHER NYO\n";
            }else{
                echo "\e[+] ".$claim."\n";
            }
    }
